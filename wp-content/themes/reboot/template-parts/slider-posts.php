...
if ( ! empty( $slider_count_mod  ) ) {
    ...
    if ( ! empty( $slider_posts_ids ) ) {
        ...
        $slider_articles = get_posts( apply_filters( THEME_SLUG . '_slider_get_posts_post_in_args', [
    ...
    if ( ! empty( $slider_category_ids ) ) {
        ...
        if ( count( $slider_articles ) < $slider_count ) {
            ...
            $slider_category_articles = get_posts( apply_filters( THEME_SLUG . '_slider_get_posts_category_in_args', [
    ...
    if ( count( $slider_articles ) < $slider_count ) {
        ...
        $slider_articles_second = get_posts( apply_filters( THEME_SLUG . '_slider_get_posts_rand_args', [
            'posts_per_page' => $delta,
            'post__not_in'   => $post__not_in,
            'meta_key'       => $slider_posts_meta_key,
            'orderby'        => $slider_posts_orderby,
