 ...
 * @package Wpshop\Core
 *
 * @version 1.5 2021-05-26 add public method increment_views, add wpshop_core_views_counter:count_views
 * @version 1.4 2021-05-17 add support wp fastest cache, add wpshop_core_views_counter:cache_enabled
 * @version 1.3
 * @updated 1.2 2020-04-13
 * @updated 1.3 2020-04-15
 */
class ViewsCounter {
    ...
    public function __construct( Core $core, ThemeOptions $options, AdminNotices $notices, $script_handle = null ) {
        ...
        $this->script_handle = $script_handle ?: $options->theme_slug;
    }
